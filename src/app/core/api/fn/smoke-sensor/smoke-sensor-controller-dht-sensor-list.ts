...
export function smokeSensorControllerDhtSensorList(http: HttpClient, rootUrl: string, params: SmokeSensorControllerDhtSensorList$Params, context?: HttpContext): Observable<StrictHttpResponse<PaginationOutput & {
