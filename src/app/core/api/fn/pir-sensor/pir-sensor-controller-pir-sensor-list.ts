...
export function pirSensorControllerPirSensorList(http: HttpClient, rootUrl: string, params: PirSensorControllerPirSensorList$Params, context?: HttpContext): Observable<StrictHttpResponse<PaginationOutput & {
