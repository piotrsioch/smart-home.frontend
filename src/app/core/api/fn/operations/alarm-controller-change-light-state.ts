...
export function alarmControllerChangeLightState(http: HttpClient, rootUrl: string, params: AlarmControllerChangeLightState$Params, context?: HttpContext): Observable<StrictHttpResponse<void>> {
