...
export function notificationControllerGetNotificationById(http: HttpClient, rootUrl: string, params: NotificationControllerGetNotificationById$Params, context?: HttpContext): Observable<StrictHttpResponse<void>> {
