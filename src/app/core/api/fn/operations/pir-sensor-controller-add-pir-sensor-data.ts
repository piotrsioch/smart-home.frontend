...
export function pirSensorControllerAddPirSensorData(http: HttpClient, rootUrl: string, params: PirSensorControllerAddPirSensorData$Params, context?: HttpContext): Observable<StrictHttpResponse<void>> {
