...
export function alarmControllerGetAlarmState(http: HttpClient, rootUrl: string, params: AlarmControllerGetAlarmState$Params, context?: HttpContext): Observable<StrictHttpResponse<void>> {
