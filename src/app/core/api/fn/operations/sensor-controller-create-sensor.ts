...
export function sensorControllerCreateSensor(http: HttpClient, rootUrl: string, params: SensorControllerCreateSensor$Params, context?: HttpContext): Observable<StrictHttpResponse<void>> {
