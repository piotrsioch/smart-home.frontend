...
export function alarmControllerAlarmList(http: HttpClient, rootUrl: string, params: AlarmControllerAlarmList$Params, context?: HttpContext): Observable<StrictHttpResponse<void>> {
