...
export function lightControllerChangeLightState(http: HttpClient, rootUrl: string, params: LightControllerChangeLightState$Params, context?: HttpContext): Observable<StrictHttpResponse<void>> {
